...
示例用法:
    ...
    python master_pipeline.py ../MinerU/outputs_clean/ChatDev_short_image/ChatDev_short.md ../MinerU/outputs_clean/ChatDev_short_image/images
        """
    )
