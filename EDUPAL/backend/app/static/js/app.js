...
function showProcessingInSameCard(processId, title) {
    ...
    if (!uploadSuccessActions) return;
    ...
    uploadSuccessActions.innerHTML = `
        <div class="upload-success-info">
            ...
            <div class="success-message">
                <div class="success-title">正在处理: ${title}</div>
                <div class="success-filename">任务ID: ${processId.slice(0, 8)}...</div>
            </div>
        </div>
        ...
        <div class="processing-actions">
            <button class="btn btn-outline btn-sm" onclick="cancelProcessing()" id="cancelBtn">取消处理</button>
        </div>
    `;
