...
# def main(input_pdf_path, output_dir=None):
...
#     # 构建用于 master_pipeline_ppt.py 的路径
...
#     # Step 2: Run master_pipeline_ppt.py
...
#     parser = argparse.ArgumentParser(description="运行完整的论文处理流程")
